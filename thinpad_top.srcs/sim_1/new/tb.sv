...
parameter BASE_RAM_INIT_FILE = "E:\\thinpad_top\\thinpad_top.test\\kernel.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
parameter EXT_RAM_INIT_FILE = "E:\\thinpad_top\\thinpad_top.test\\kernel.bin";    //ExtRAM初始化文件，请修改为实际的绝对路径
parameter FLASH_INIT_FILE = "E:\\thinpad_top\\thinpad_top.test\\kernel.bin";    //Flash初始化文件，请修改为实际的绝对路径
